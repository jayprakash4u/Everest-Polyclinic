  ...
  return (
    <>
      <AdminPageHeader
        ...
        subtitle="Manage packages on /health-packages and the homepage carousel (use Show on homepage)."
      />
        ...
        <section className="space-y-6">
          ...
          >
            ...
            <label className="flex items-center gap-2 text-sm text-slate-600">
              <input
                type="checkbox"
                checked={packageForm.showOnHomepage}
                onChange={(event) =>
                  setPackageForm((prev) => ({
                    ...prev,
